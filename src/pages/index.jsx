    ...
    runs.forEach((run) => {
        ...
        if (periodName) {
            runPeriod[periodName] =
                runPeriod[periodName] === undefined
                    ? 1
...
export default () => {
    ...
    const [runs, setActivity] = useState(
        filterAndSortRuns(activities, year, sortDateFunc)
    );
    ...
    return (
        <div className="fl w-100 w-30-l pb5 pr5-l">
            <section className="pb4" style={{ paddingBottom: "0rem" }}>
                <p>
                    Siddhartha / {yearsArr.length} / {year}
                    <br />
                </p>
            </section>
            <hr color="red" />
...
const LocationSummary = () => (
    <div style={{ cursor: "pointer" }}>
        <section>
            <Stat value={`${yearsArr.length}`} description=" Year" />
            ...
            <ul className={styles.buttons}>
                {yearsButtons.map((year) => (
                    <li
                        ...
                        style={{
                            color:
                                year === thisYear ? "rgb(224,237,94)" : "white",
                        }}
                        year={year}
                        onClick={(e) => {
                            changeYear(year);
...
const Stat = ({ value, description, className, citySize }) => (
